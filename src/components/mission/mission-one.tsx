          ...
          <div className="col-xl-12">
            <div className="tp-mission-title-box mb-80 text-center">
              <h4 className="tp-about-5-title tp_fade_bottom p-relative">
                ...
                Transform <br /> the fan experience
              </h4>
            </div>
          </div>
        </div>
          ...
          <div className="col-xl-6 col-lg-6 col-md-6">
            <div className="tp-mission-content">
              <p className="tp_fade_bottom">
                To revolutionize fan engagement by seamlessly integrating
                technology and creativity across various platforms, empowering
                fans to connect with brands and artists in immersive, rewarding
                ways.!
              </p>
