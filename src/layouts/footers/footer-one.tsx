                        ...
                        <div className="tp-footer-widget-info">
                          ...
                          <div className="tp-footer-widget-info-location tp_fade_bottom">
                            <a
                              ...
                              target="_blank"
                            >
                              2000 S Michigan Ave <br />Chicago IL, 60616
                            </a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="tp-footer-widget">
                        ...
                        <ul className="tp-footer-widget-social">
                          <li className="tp_fade_bottom">
                            <a href="https://www.linkedin.com/company/lagos-labs">LinkedIn</a>
                          </li>
                          <li className="tp_fade_bottom">
                            <a href="https://instagram.com/lagoslabs">Instagram</a>
                          </li>
                          <li className="tp_fade_bottom">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-xl-6 col-md-8">
                <div className="tp-copyright-text text-center text-md-end">
                  <p>
                    Copyright © {new Date().getFullYear()} Lagos Labs. All rights
                    reserved.
                  </p>
                </div>
              </div>
